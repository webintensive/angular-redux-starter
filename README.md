...
* `npm run typings`: removes existing typings located in *typings* directory, reinstalls them based on *tsd.json*, and linkes whatever is available in *node_modules* (using `tsd link`).
